...
class VideoEncoder(nn.Module):
    ...
    def forward(self,x):
         #[batch_size,frames,channels,height,width]_>[batch_size,channels,frames,height,width]
         x=x.transpose(1, 2)
...
class MultimodalSentimentmodel(nn.Module):
    def __init__(self):
        ...
        self.emotion_classifier=nn.Sequential(
            ...
            nn.ReLU(),
            nn.Dropout(0.2),
            nn.Linear(64,7)# anger,sadness  7 sentiments
        )
    ...
    def forward(self,text_inputs,video_frames,audio_features):
        ...
        #concanate multimodal features
        combines_features = torch.cat([
            text_features,
            video_features,
            audio_features,
        ...
        #fused layer
        fused_features=self.fusion_layer(combines_features)
...
if __name__ == "__main__":
    ...
    with torch.inference_mode():
        ...
        emotion_probs = torch.softmax(output['emotions'],dim=1)[0]
        sentiment_probs = torch.softmax(output['sentiments'],dim=1)[0]
        ...
        print("prediction for Utterance:")
